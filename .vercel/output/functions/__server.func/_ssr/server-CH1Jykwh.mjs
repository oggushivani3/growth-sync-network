...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C8nkzSz2.mjs");
...
const manifest = {
  "51a7de1f6b4128453bcca3bb79867bc7d069c18708ab3e5f046094858802554e": {
    functionName: "getMindsetMatches_createServerFn_handler",
    importer: () => import("./match.functions-C9oGpbIO.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DASSJNse.mjs").then((n) => n.r),
    import("./start-Bz_Hpu8s.mjs"),
